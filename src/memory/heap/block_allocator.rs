...
use super::{free_list_allocator::FreeListAllocator, locked::Locked};
...
pub struct BlockAllocator {
    ...
    fallback_allocator: FreeListAllocator
}
...
impl BlockAllocator {
    pub const fn new() -> Self {
        ...
        Self {
            ...
            fallback_allocator: FreeListAllocator::new(),
        }
    }
    ...
    unsafe fn fallback_dealloc(&mut self, ptr: NonNull<u8>, layout: Layout) {
